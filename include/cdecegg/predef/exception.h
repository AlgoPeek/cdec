...
{
	// Namespaces
	ECNS_General = 1,				// General exceptions
	...
	EC_ParentNotFound,				// Parent not found
	...
	EC_IO_NotFile,					// Target is not a file
	EC_IO_NotDirectory,				// Target is not a directory
	EC_IO_DirNotEmpty,				// Directory not empty
};
